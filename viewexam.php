...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="panel-title fw-bold">View Answers</h3>
                    </div>                    
                </div>
            </div>
   ...
   <?php
                ...
                if($success == 1){
?>
    <h2 class="text-center fw-bold">For Question 1</h2>
    ...
    <?php
     if (!$value['qsn2'] == "") {
    ?>
        <h2 class="text-center fw-bold">For Question 2</h2>
    ...
    <?php
     if (!$value['qsn3'] == "") {
    ?>
        <h2 class="text-center fw-bold">For Question 3</h2>
    ...
    <?php
     if (!$value['qsn4'] == "") {
    ?>
        <h2 class="text-center fw-bold">For Question 4</h2>
    ...
    <?php
     if (!$value['qsn5'] == "") {
    ?>
        <h2 class="text-center fw-bold">For Question 5</h2>
                ...
                ?>
                        ...
                        <?php
                           ...
                           <h3 class="text-center"><?php echo  $question5; ?></h3>
                            ...
                            <?php } ?>
                            <div class="col-12">
                                <button type="submit" id="button" name="submit" class="btn btn-danger">Submit</button>
                            </div>
